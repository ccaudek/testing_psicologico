...
- $a_{ij}$: differenza sistematica nelle medie tra le misure.
- $b_{ij}$: differenza di scala rispetto al costrutto latente misurato.
...
- Differenze sostanziali nelle medie dei punteggi veri ($a_{ij} \neq 0$).
- Differenze nella scala dei punteggi veri ($b_{ij} \neq 1$).
- Differenze sostanziali nelle varianze degli errori di misura.
