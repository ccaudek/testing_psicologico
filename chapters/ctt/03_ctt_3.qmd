...
Se assumiamo che $\sigma_X = \sigma_Y$ (varianza uguale per entrambe le misure), possiamo semplificare il numeratore:

$$
r_{dd} = \frac{r_{xx} + r_{yy} - 2 r_{xy} \sqrt{r_{xx} r_{yy}}}{2(1 - r_{xy})}
$$

Semplificando ulteriormente, otteniamo la **formula di Lord**:

$$
r_{dd} = \frac{0.5\,(r_{xx} + r_{yy}) - r_{xy}}{1 - r_{xy}}
$$

Questa formula mostra come l'affidabilità del punteggio differenza dipenda dalle affidabilità delle misure individuali e dalla loro correlazione.
