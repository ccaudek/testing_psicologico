...
pacman::p_load(
  lavaan, psych, BifactorIndicesCalculator, semPlot, semTools, esemComp
)
```
...
**1. Indici di adattamento del modello**
...
**2. Log-Likelihood e Criteri Informativi**

| Metrica  | ESEM  | CFA  |
|----------|------|------|
| **Loglikelihood (H0)** | -3706.541 | -3706.541 |
| **AIC** | 7479.081 | 7479.081 |
| **BIC** | 7601.416 | 7601.416 |

*Conclusione**: nessuna differenza nei criteri informativi tra i due metodi.

**3. Caricamenti fattoriali**

Per esempio:

| Item | Caricamento ESEM | Caricamento CFA |
|------|----------------|----------------|
| x1 | 0.712 | 0.606 |
| x2 | 0.628 | 0.525 |
| x3 | 0.796 | 0.670 |
...
**4. Covarianze tra i fattori**

| Covarianza | Stima ESEM | Stima CFA |
|------------|-----------|-----------|
