...
- Valutare l’adeguatezza di diverse strategie di gestione dei dati mancanti in base al meccanismo sottostante.
- Applicare metodi di gestione come listwise deletion, pairwise deletion e imputazione dei dati.
- Scegliere e implementare tecniche avanzate come Multiple Imputation e Expectation-Maximization.
- Utilizzare il metodo Full Information Maximum Likelihood (FIML) per analisi robusta in contesti CFA e SEM.
- Esplorare i dati mancanti e calcolare la loro copertura utilizzando strumenti in R.
- Creare e adattare modelli statistici con gestione dei dati mancanti direttamente integrata.
:::
